...
class UncodeLoopQueryBuilder extends VcLoopQueryBuilder
{
	...
	public function single_variations_include_by_id_childs( $args, $wp_query ) {
		...
		if ( isset( $wp_query->query_vars['post__in'] ) && is_array( $wp_query->query_vars['post__in'] ) ) {
	...
	public function single_variations_exclude_by_id_childs( $args, $wp_query ) {
		...
		if ( isset( $wp_query->query_vars['post__not_in'] ) && is_array( $wp_query->query_vars['post__not_in'] ) ) {
			$excluded_ids = implode( ",", $wp_query->query_vars['post__not_in'] );

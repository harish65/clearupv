...
$add_text_size = uncode_core_vc_params_get_text_size( 'single_text_lead', false, esc_html__("Blocks", 'uncode-core'), array( 'element' => 'index_type', 'value' => array( 'isotope', 'carousel','css_grid', 'table', 'custom_grid', 'sticky-scroll' ) ) );
...
if ( class_exists( 'WooCommerce' ) && ot_get_option( '_uncode_woocommerce_enable_single_variations' ) === 'on' ) {
	$uncode_index_params_single_variations = array(
		...
		'group' => esc_html__('General', 'uncode-core') ,
		"description" => esc_html__("Activate this to have your product variations available as single products in the shop, category & search results when using the Posts module. NB. Please also activate the dedicated option in the Theme Options.", 'uncode-core') ,
		"value" => Array(
			esc_html__("Yes, please", 'uncode-core') => 'yes'
		) ,
	);
...
$uncode_index_params_third = array(
  ...
  array(
	...
	array(
		...
		'dependency' => array(
			'element' => 'index_type',
			'value' => array('isotope','carousel', 'css_grid', 'custom_grid', 'sticky-scroll'),
		) ,
	) ,
	array(
		'type' => 'dropdown',
		...
		'dependency' => array(
			'element' => 'index_type',
			'value' => array('isotope','carousel','css_grid','table', 'custom_grid', 'sticky-scroll'),
		) ,
	) ,
	array(
		"type" => "dropdown",

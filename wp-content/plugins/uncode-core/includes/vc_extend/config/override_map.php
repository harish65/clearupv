...
$tab_label_typo_params         = uncode_core_vc_params_get_wc_heading_options( $heading_font, $heading_size, $heading_weight, $heading_height, $heading_space, array('typography', 'advanced') );
...
require_once UNCODE_CORE_PLUGIN_DIR . '/includes/vc_extend/modules/lottie/lottie.php';

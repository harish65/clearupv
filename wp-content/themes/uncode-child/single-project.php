...
while ( have_posts() ) : the_post();
    ...
    if ( $layout === 'sidebar_right' || $layout === 'sidebar_left' ) {
        ...
        include get_stylesheet_directory() . '/partials/sidebar-project.php';
        ...
        $main_content = 	'<div class="col-lg-'.$main_size.' project-single-content">
        ...
        $the_content = '<div class="row-container">
	        							<div class="row row-parent un-sidebar-layout' . $row_classes . $limit_content_width . '"' . $page_custom_width . '>
													<div class="row-inner">
														...
														<div class="col-lg-' . $sidebar_size . ' col-widgets-sidebar ' . $sidebar_mobile_collapse_class . ' project-single-sidebar">
...
<div class="prev-next-post">
    ...
    <div class="prev-next-post-wrapper">
        ...
        {
            ?>
            <a href="<?php echo $previous_post_url;?>" class="prev-post prev-next-col"><span class="arrow"></span>prev</a>
            <?php
        }
        ?>
         <a href="<?php echo site_url();?>/projects/" class="proj-page prev-next-col">projects page</a>
            <?php
        if(!empty($next_post_url))
        {
            ?>
            <a  href="<?php echo $next_post_url;?>" class="next-post prev-next-col">next<span class="arrow"></span></a>
            <?php
        }
        ?>

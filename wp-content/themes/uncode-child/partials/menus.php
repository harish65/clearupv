			...
			if ($no_secondary !== 'on' && isset($theme_locations['secondary'])) {
				...
				$secondary_menu_html = wp_nav_menu(
														array(
																...
																'items_wrap'           => '<ul id="%1$s" class="%2$s"><script src="https://app.sharelinktechnologies.com/widget/js" crossorigin="anonymous" defer></script> 
<li class="asx-price-tag"> <iframe width="100%" frameborder="0" class="sharelink" scrolling="no" style="width: 1px;min-width: 100%;" src="https://app.sharelinktechnologies.com/widget/036ff7e8-19fc-40b0-bd2e-0ea881678daf" loading="lazy"></iframe> </li> %3$s </ul>',
																"echo"            => 0
															)
														);

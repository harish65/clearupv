...
// 		}
// 	}
		$footer_icons = '<div style="color:white !important;" class="uncell col-lg-6 pos-middle text-'.($footer_position === 'center' ? $footer_position : $alignArray[!array_search($footer_position, $alignArray)]).'"><a href="/privacy-policy/" style="color:white !important;">Privacy Policy<a/>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="/terms-of-use-of-website/" style="color:white !important;">Terms of Use<a/>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="/copyright-notice/" style="color:white !important;">Copyright Notice<a/>' . $footer_icons . '</div>';
	...
	if (($footer_text_content !== '' || $footer_icons !== '')) {
		...
		if ( $footer_block !== '' && $footer_block !== 'none' && function_exists('vc_is_page_editable') && vc_is_page_editable() ) {
			...
			$class_footer .= ' has_content_block';
				...
				<?php
				if ($is_redirect !== true && $menutype === 'vmenu' && $vmenu_position === 'right' ) {
...
wp_footer(); 
?>
<style>.site-footer .footer-last .limit-width {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -ms-flex-wrap: wrap;
...
background-image: url(https://www.clearvuepv.com/staging/1036/wp-content/uploads/2023/10/boxes.png);
...
.site-footer .footer-last {
	...
	.site-footer .footer-last .uncell.col-lg-6.pos-middle.text-left p:first-child {color:white; font-size:14px;
</style>
